...
/* need to give full path of the xml file */

	ezxml_t f1 = ezxml_parse_file("/home/suhaspillai/ExpertSystem_MLSoftware/C/FANN-2.2.0-Source/examples/test.xml"), classification, temp, algo, temp2;
